...
while 1:
  ...
  modifiedMessage = 'default_error_message'
  if decodedMessage[:2] == 'a:':
    modifiedMessage = decodedMessage[2:].upper()
  elif decodedMessage[:2] == 'b:':
    modifiedMessage = decodedMessage[2:].lower()
